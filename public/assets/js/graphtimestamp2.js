...
const nbOfEltsd = 300;
    ...
    firebase.database().ref('Perangkat2/hujan/1/hujanpermenit').limitToLast(nbOfElts1).on('value', ts_measures => {
    let timestamp = [];
    let nilai = [];
    ts_measures.forEach(ts_measure => {
     ...
     firebase.database().ref('Perangkat2/hujan/2/hujanpermenit').limitToLast(nbOfEltsc).on('value', ts_measures1 => {
    let timestamp1 = [];
    let nilai1 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/3/hujanpermenit').limitToLast(nbOfEltsd).on('value', ts_measures2 => {
    let timestamp2 = [];
    let nilai2 = [];
    ts_measures2.forEach(ts_measure2 => {
     ...
     firebase.database().ref('Perangkat2/hujan/4/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures3 => {
    let timestamp3 = [];
    let nilai3 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/5/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures4 => {
    let timestamp4 = [];
    let nilai4 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/6/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures5 => {
    let timestamp5 = [];
    let nilai5 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/7/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures6 => {
    let timestamp6 = [];
    let nilai6 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/8/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures7 => {
    let timestamp7 = [];
    let nilai7 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/9/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures8 => {
    let timestamp8 = [];
    let nilai8 = [];
    ...
    firebase.database().ref('Perangkat2/hujan/10/hujanpermenit').limitToLast(nbOfEltsb).on('value', ts_measures9 => {
    let timestamp9 = [];
    let nilai9 = [];
    ...
    const layout = {
        title: '<b>Nilai Curah Hujan Pada Wilayah Pangalengan (Perangkat 2) </b>',
        titlefont: {
